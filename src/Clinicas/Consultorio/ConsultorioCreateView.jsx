...
function CreateConsultorio({ navigation }) {
    ...
    const buttonHandler = async () => {
        const token = await sm.getTokenSession()
		if(nombre === '' || nombre === null){ setAlertType('Warning'); setAlertMessage('El campo Direccion es un campo obligatorio.'); setError(true); return; }
      ...
      let request = {
        ...
        await consultorioController.createConsultorio(request, token).then(async (response)=>{
